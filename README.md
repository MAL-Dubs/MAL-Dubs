...
MAL Dubs is a userscript which labels 3942 English dubbed titles on MyAnimeList.net and adds dub only filtering to search, seasonal and top anime pages.
